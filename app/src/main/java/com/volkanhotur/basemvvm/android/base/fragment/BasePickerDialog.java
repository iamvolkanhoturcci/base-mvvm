...
public abstract class BasePickerDialog<VM extends ViewModel, VDB extends ViewDataBinding, T> extends AbstractBottomSheetDialog<VM, VDB> {
    ...
    public abstract BasePickerDialog setTitle(@StringRes int title);

    public abstract BasePickerDialog setData(List<T> data);

    public abstract BasePickerDialog filter(boolean enable);
}
